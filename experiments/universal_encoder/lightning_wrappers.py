...
class LightningMultiTaskWrapper(L.LightningModule):
    def __init__(
        ...
        row_encoder_config: Optional[dict[str, Any]] = None,
        ...
        self.row_encoder_config = row_encoder_config
    ...
    def save_pretrained(self, path: str):
        save_dict = {
            "row_encoder_state_dict": self.row_encoder.state_dict(),
            "row_encoder_config": self.row_encoder_config,
        }
        if self.gnn is not None:
...
class SavePretrainedCallback(L.Callback):
    ...
    def on_validation_epoch_end(
        ...
        if is_best:
            ...
            pl_module.save_pretrained(f"{self.save_dir}/best_model.pt")
